/** This file is generated by scripts/generate_types_definition.js, please do not edit it. */
...
declare namespace __Square {
  ...
  class InvalidStylesError {
    errors: Array<InvalidInputStyleValueError | InvalidInputStylePropertyError | InvalidInputStyleSelectorError>;
    message: string;
    name: string;
    stack?: string | undefined;
  }
  ...
  interface PaymentRequest {
    ...
    addEventListener(
      ...
      callback:
        | ((contact: ShippingContact) => PaymentRequestUpdate | Promise<PaymentRequestUpdate>)
        | ((option: ShippingOption) => PaymentRequestUpdate | Promise<PaymentRequestUpdate>),
    ): void;
    /**
   ...
   */
  function payments(applicationId: string, locationId?: string | undefined): Payments;
  ...
  /**
   */
  type TokenStatus = 'Abort' | 'Cancel' | 'Error' | 'Invalid' | 'OK' | 'Unknown';
   ...
   */
  type CardFieldNames = 'cardNumber' | 'cvv' | 'expirationDate' | 'postalCode';
   ...
   */
  type PaymentRequestEvent = 'shippingcontactchanged' | 'shippingoptionchanged';
}

export type Square = typeof __Square;
